...
const Review = ({ img, name, city, text, custom }) => {
  return (
    <div className="w-[370px] lg:w-[310px] xl:w-[370px]">
      <motion.div
      ...
      >
        <div className="home__people flex gap-[23px] mb-[25px]">
          ...
          <div className="home__info">
            ...
            <div className="home__city text-[22px] font-[#292f36] lg:text-[18px] xl:text-[22px]">
              {city}
            </div>
          </div>
        </div>
        <div className="home__text text-[22px] lg:text-[18px] text-[#4d5053] xl:text-[22px]">
          {text}
        </div>
      </motion.div>
    </div>
